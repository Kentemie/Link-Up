...
from .views import (
    ...
    UserPasswordResetConfirmView, UserRegisterView, 
    UserConfirmEmailView, EmailConfirmationSentView, 
...
urlpatterns = [
    ...
    path('user/follow/<slug:slug>/', ProfileFollowingCreateView.as_view(), name='follow'),
