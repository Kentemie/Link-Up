# Generated by Django 4.2.6 on 2023-10-31 03:09
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=mptt.fields.TreeForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='articles', to='blog.category', verbose_name='Category'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
        ...
        migrations.AddField(
            model_name='article',
            name='the_one_who_updated',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts_updater', to=settings.AUTH_USER_MODEL, verbose_name='The one who updated'),
        ),
        migrations.AddField(
            model_name='article',
            name='viewers',
            field=models.ManyToManyField(blank=True, related_name='article_viewers', to='blog.viewer', verbose_name='Views'),
        ),
        migrations.AddIndex(
            model_name='viewer',
            index=models.Index(fields=['-viewed_on'], name='blog_viewer_viewed__e490dc_idx'),
        ),
        migrations.AddIndex(
            model_name='rating',
            index=models.Index(fields=['-created_at', 'value'], name='blog_rating_created_7cb6e7_idx'),
        ),
        ...
        migrations.AddIndex(
            model_name='comment',
            index=models.Index(fields=['-created_at', 'updated_at', 'status', 'parent'], name='app_comment_created_4bf37a_idx'),
        ),
        migrations.AddIndex(
            model_name='article',
